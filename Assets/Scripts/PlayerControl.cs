...
public class PlayerControl : MonoBehaviour
{
    ...
    public float CountDown = 25f;
    public TextMeshProUGUI youFinished;
    public TextMeshProUGUI timeLeft;
    private AudioSource playerAudio;
    public AudioClip death;
    public TextMeshProUGUI killThis;
    ...
    public void StartGame()
    {
        ...
        killThis.gameObject.SetActive(false);
    }
    void GameOver()
    {
    ...
    void Update()
    {
        ...
        if (crntLvl == 3)
        {
            ...
            timeLeft.text = "Timer: " + Mathf.Round(CountDown * 10)/10;
            if (CountDown < 0)
            {
                GameOver();
                CountDown = 0;
        ...
        if (crntLvl == 4)
        {
            youFinished.gameObject.SetActive(true);
        }
    }
